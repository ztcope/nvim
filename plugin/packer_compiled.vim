...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/auto-pairs"
  },
  ["lualine.nvim"] = {
    loaded = true,
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/nord-vim"
  },
  ["nvim-compe"] = {
    loaded = true,
  ...
  tcomment_vim = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/tcomment_vim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ["vim-projectroot"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/vim-projectroot"
  }
}
